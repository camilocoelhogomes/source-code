...
| ARCHITECT_UNIT_TESTS | unit-test-plan.md `0.1.1` + `tests/unit/e2e/` | `APPROVED_BY_ARCHITECT` | tech-lead-architect | 2026-07-18 | MAJOR: run_mvp_e2e/main sem Robot real, CI blank, redaction tautologia, L05/L06 — corrigidos; exclude bdd015; down idempotente; sem compose up. |
| ARCHITECT_IMPLEMENTATION | `src/github_rag/e2e/` + `e2e/robot/` + fixtures | `APPROVED_BY_ARCHITECT` | tech-lead-architect | 2026-07-18 | BLOCKING robot_runner args duplicados + MAJOR gitlink sample-local corrigidos; cov 96.53%; ver `reviews.md`. |
| ARCHITECT_BLUE | refactoring.md | `BLUE_APPROVED_BY_ARCHITECT` | tech-lead-architect | 2026-07-18 | Blue N/A (sem complexidade/gargalo); baseline testes/cobertura registrada. |
