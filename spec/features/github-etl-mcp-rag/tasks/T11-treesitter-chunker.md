...
- Porta `ContextualChunker` baseada no pacote oficial **`tree-sitter`** + grammars oficiais (DEC-015 / BR-023).
...
- DEC-003, DEC-015; BR-023; REQ-022 (etapa Tree-sitter); BDD-007; BDD-024.
