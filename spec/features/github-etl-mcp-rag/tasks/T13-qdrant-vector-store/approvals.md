# Aprovações — T13-qdrant-vector-store

| Gate | Versão / Commit | Decisão | Autor | Data | Observações |
|---|---|---|---|---|---|
| Design | `0.1.0` | `APPROVED_BY_ARCHITECT` | Tech Lead Architect | 2026-07-18 | Pipeline autônomo |
| Design (delta índices) | `0.1.1` | `APPROVED_BY_ARCHITECT` | Tech Lead Architect | 2026-07-18 | PR #13: payload indexes obrigatórios no setup |
| BDD | `0.1.1` | `APPROVED_BY_ARCHITECT` | Tech Lead Architect | 2026-07-18 | Pipeline autônomo; sem VS-15 (setup → unitário) |
| Interfaces | `0.1.0` | `APPROVED_BY_ARCHITECT` | Tech Lead Architect | 2026-07-18 | Pipeline autônomo |
| Interfaces (delta índices) | `0.1.1` | `APPROVED_BY_ARCHITECT` | Tech Lead Architect | 2026-07-18 | KEYWORD indexes; porta inalterada |
